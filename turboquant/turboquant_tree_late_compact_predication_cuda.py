...
def _load_ext():
    ...
    src = root / "csrc" / "turboquant_tree_late_compact_predication_cuda.cu"

    _EXT = load(
        name="turboquant_tree_late_compact_predication_cuda_ext",
        sources=[str(src)],
...
@torch.no_grad()
def turboquant_polar_tree_l2_combined_lut_fp16_compact_late_polar_only_cuda(
    *,
    ...
    return ext.turboquant_polar_tree_l2_combined_lut_fp16_compact_late_polar_only_cuda(
...
@torch.no_grad()
def turboquant_polar_tree_l2_combined_lut_fp16_compact_late_lane_nibble_fused_logits_cuda(
    *,
    ...
    cos_l3, sin_l3 = _trig(centroids_l3)
    cos_l4, sin_l4 = _trig(centroids_l4)
    return ext.turboquant_polar_tree_l2_combined_lut_fp16_compact_late_lane_nibble_fused_logits_cuda(
